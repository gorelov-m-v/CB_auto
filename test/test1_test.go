...
//	database               *sql.DB
//	adminResponse          *requests.AdminCheckResponseBody
...
//	t.Description(`
//        Проверка содания бренда.`)
//
//	t.Tags("BeforeAfter")
//	t.WithNewStep("Чтение конфигурационного файла.", func(sCtx provider.StepCtx) {
//		s.config, _ = config.ReadConfig()
//	})
...
//		if s.adminResponse == nil || !utils.CheckTokenExpiry(s.adminResponse) {
...
//				},
//			}
//			s.adminResponse, _ = requests.CheckAdmin(s.client, adminCheckRequest)
//		}
//	})
//}
//
//func (s *SetupSuite) TestSetupSuite(t provider.T) {
...
//			QueryParams: requests.CapGameListRequestQueryParams{
...
//				PerPage:       100,
//			},
//			Headers: requests.CapGameListRequestHeaders{
//				Authorization:  "Bearer " + s.adminResponse.Token,
//				PlatformLocale: "ru",
//			},
//		}
...
//			},
//		}
//		s.createCapBrandResponse, _ = requests.CreateCapBrand(s.client, createCapBrandRequest)
//
//		requestAttachment, _ := utils.FormatRequest(createCapBrandRequest, s.config)
//		responseAttachment, _ := json.Marshal(s.createCapBrandResponse)
//		sCtx.WithAttachments(allure.NewAttachment("request", allure.JSON, []byte(requestAttachment)))
//		sCtx.WithAttachments(allure.NewAttachment("response", allure.JSON, responseAttachment))
//	})
//
...
//				UUID: s.createCapBrandResponse.ID,
//			},
