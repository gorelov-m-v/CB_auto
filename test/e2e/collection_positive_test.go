...
func (s *CollectionPositiveSuite) TestCollectionFields(t provider.T) {
	testCases := []struct {
		...
		{"Максимальная длина названия", utils.GenerateCollectionTitle(25), utils.GenerateAlias(10), http.StatusOK},
		{"Минимальная длина alias", utils.GenerateCollectionTitle(10), utils.GenerateAlias(2), http.StatusOK},
		{"Максимальная длина alias", utils.GenerateCollectionTitle(10), utils.GenerateAlias(100), http.StatusOK},
	}
